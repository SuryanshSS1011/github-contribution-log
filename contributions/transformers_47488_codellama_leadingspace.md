...
Issue #47487 is still being fixed, now by #47862, and my follow-up Llama PR #47700 is closed in favour of it. Phases I to IV below are the record as it stood at merge time, except the Learnings section, which is revised to reflect the revert. Read the rest with this correction in mind.
